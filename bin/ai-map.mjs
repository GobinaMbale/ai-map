...
function discoverProjects(root, maxDepth = WS_MAX_DEPTH) {
  const found = [];
...
// ----- Modèle workspace ----------------------------------------------------
function buildWorkspace(ctx, maxDepth) {
